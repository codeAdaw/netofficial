     ...
     { initDone &&
        <main className="bg-block h-fit w-full flex-1 absolute top-0 box-border bg-[#100F22] relative selector">
           <ReactFullpage.Wrapper>
            <div className="section mx-auto w-full lg:h-screen sm:h-banner bg-cover relative ">
                <Suspense>
                ...
                <div className="lg:w-1/2 lg:h-24 md:h-96 m-auto text-center absolute sm:top-96 lg:top-0 bottom-0 left-0 right-0">
                    <h1 ref={typedel} id="tttt" className="lg:text-8xl md:text-6xl sm:text-5xl sm:mt-24 lg:mt-0 font-extrabold text-write-900"></h1>
            ...
            {/* part 1 */}
                <div className="section mx-auto w-full lg:h-screen sm:h-auto bg-cover flex lg:flex-row sm:flex-col-reverse sm:text-center items-center lg:px-28 lg:gap-x-14 sm:px-mspace relative">
