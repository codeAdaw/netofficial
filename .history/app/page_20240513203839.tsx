                        ...
                        return (
                            <ReactFullpage.Wrapper>
                                  <div id="bannerWrap" className="section mx-auto w-full lg:h-screen bg-cover relative">
                                        <video className="lg:w-full lg:h-full sm:w-full sm:h-banner" autoPlay muted loop>
                                            <source src="/bannerv.mp4" type="video/mp4" loop/>
                                        </video>
                                        {/* <Suspense> */}
                            ...
                            {/* part 2 */}
                                ...
                                <div className="section bg-[#100F22] mx-auto w-full lg:h-screen sm:h-screen bg-cover relative z-9">
                                    <div className='lg:h-auto lg:relative sm:relative mx-auto w-auto lg:px-28 sm:px-mspaces 3xl:w-3/4'>
                                        <h2 className='lg:text-4xl lg:mb-12 sm:text-2xl sm:mb-20 text-center font-medium sm:px-mspace'>{intl.get('PART3H1')}</h2>
                                ...
                                <div className="section bg-[#100F22] mx-auto w-full lg:h-screen sm:h-hpart4 relative">
                                    ...
                                    <div className='lg:px-28 sm:px-mspace 3xl:w-3/4 3xl:relative' >
                                        ...
                                        <h2 className='lg:text-4xl sm:text-3xl font-medium mb-10 text-center border-solid border-b border-white lg:leading-maxx sm:leading-maxx'>{intl.get('PART4H1')}</h2>
