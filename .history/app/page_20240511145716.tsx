                ...
                <ReactFullpage
                    ...
                    render={({ state, fullpageApi }) => {
                        return (
                            ...
                            {/* part 1 */}
                                <div className="section bg-[#100F22] mx-auto w-full lg:h-screen sm:h-auto bg-cover  lg:px-28 lg:gap-x-14 sm:px-mspace">
                                    <div className="flex lg:flex-row sm:flex-col-reverse sm:text-center items-center">
