                            ...
                            {/* part 1 */}
                                <div className="section bg-[#100F22] mx-auto w-full lg:h-screen sm:h-auto bg-cover lg:px-28  sm:px-mspace">
                                    <div className="flex lg:flex-row sm:flex-col-reverse sm:text-center items-center lg:gap-x-14 3xl:w-3/4 mx-auto">
                                        ...
                                        <div className="z-9 lg:basis-3/5 lax lax_preset_fadeIn:50:100 lax_preset_spin z-1">
                                        ...
                                        <div className="lg:w-120 lg:h-120 sm:w-100 sm:h-100 lg:basis-2/5 bg-s2bg bg-100% z-1">
                                            <Suspense>
