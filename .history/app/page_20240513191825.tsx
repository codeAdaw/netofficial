                            ...
                            {/* part 2 */}
                                ...
                                <div className="section bg-[#100F22] mx-auto w-full lg:h-screen sm:h-hpart4 relative">
                                    ...
                                    <div className='lg:px-28 sm:px-mspace 3xl:w-3/4 3xl:relative' >
                                        ...
                                        <h2 className='lg:text-4xl sm:text-3xl font-medium mb-10 text-center border-solid border-b border-white lg:leading-maxx sm:leading-10'>{intl.get('PART4H1')}</h2>
