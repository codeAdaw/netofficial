...
export default function SwitchPage(props:any) {
  ...
  return (
    <>
        ...
        {
            initDone && path == '/' &&  <a onClick={handelPdfPage} style={isM ? {position:'absolute',right: '100px',lineHeight:'80px',top:0} : {}} href="#" className="text-sm font-semibold leading-6 text-wright">{intl.get("H2")}</a>
        }
    </>
  );
}