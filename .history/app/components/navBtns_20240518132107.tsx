 ...
 * @LastEditTime: 2024-05-18 13:21:03
...
export default function SwitchPage(props:any) {
  ...
  return (
    <>
        ...
        {
            initDone && path == '/' &&  <a onClick={handelPdfPage} href="/pefPage" className="text-sm font-semibold leading-6 text-wright">{intl.get("H2")}</a>
        }
    </>
  );
}