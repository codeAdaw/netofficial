...
export default function SwitchPage(props:any) {
  ...
  return (
    <>
        ...
        {
            initDone && path == '/' &&  <a onClick={handelPdfPage} style={isM ? {position:'absolute',right: '100px'} : {}} href="#" className="text-sm font-semibold leading-6 text-wright">{intl.get("H2")}</a>
        }
    </>
  );
}