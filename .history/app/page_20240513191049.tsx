                        ...
                        return (
                            ...
                            {/* part 2 */}
                                ...
                                <div className="section bg-[#100F22] mx-auto w-full lg:h-screen sm:h-screen bg-cover relative z-9">
                                    <div className='lg:h-auto lg:relative sm:relative top-0 bottom-0 right-0 left-0 mx-auto w-auto lg:px-28 sm:px-mspaces 3xl:w-3/4'>
                                        <h2 className='lg:text-4xl lg:mb-12 sm:text-2xl sm:mb-4 text-center font-medium'>{intl.get('PART3H1')}</h2>
                                        <img className='mx-auto h-auto realtive sm:mb-4'  src='/type3 3.png' alt=""/>
