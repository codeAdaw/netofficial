                        ...
                        return (
                            ...
                            {/* part 2 */}
                                ...
                                <div className="section bg-[#100F22] mx-auto w-full lg:h-screen sm:h-hpart5 bg-cover relative">
                                    ...
                                    <div className="absolute lg:bottom-12 sm:bottom-4 sm:mb-4 text-center lg:text-3xl sm:text-2xl mx-auto font-blod leading-10 lg:px-28 3xl:w-3/4 3xl:mx-0 left-0 right-0 sm:px-mspace'">
                                        {intl.get('ENDING')}
                                    </div>
                                </div>
                            </ReactFullpage.Wrapper>
