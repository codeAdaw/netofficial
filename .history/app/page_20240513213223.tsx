                        ...
                        return (
                            <ReactFullpage.Wrapper>
                                  <div id="bannerWrap" className="bg-[#09082a] section mx-auto w-full lg:h-screen bg-cover relative">
                                        ...
                                        {
                                           !isM && <video style={{visibility: typef ? 'visible' : 'hidden'}} className="lg:w-full lg:h-full sm:w-full sm:h-banner" autoPlay muted loop>
                                        ...
                                        {/* </Suspense> */}
                                        <div className="lg:w-1/2 lg:h-24 md:h-96 m-auto text-center absolute sm:bottom-80 lg:top-0 bottom-0 left-0 right-0">
