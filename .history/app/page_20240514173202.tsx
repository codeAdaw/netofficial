                        ...
                        return (
                            <ReactFullpage.Wrapper>
                                  <div id="bannerWrap" className="bg-[#09082a] section mx-auto w-full lg:h-screen bg-cover relative">
                                        ...
                                        {
                                           !isM && 
                                           <video style={{opacity: typef ? '1' : '0'}} className="lg:w-full lg:h-full sm:w-full sm:h-banner absolute top-0 z-0" playbackspeed={0.5}  autoPlay muted loop preload="auto">
