            ...
            for(let mutation of mutationsList) {
                ...
                if (mutation.type === 'attributes') {
                    ...
                    if(targetNode.style.transform !== "translate3d(0px, 0px, 0px)" ){
                        setTimeout(()=>{
                            bannerWrap.style.position = 'absolute';},100);
                    }else{
                        bannerWrap.style.position = 'releative';
                    }
                    // 这里可以添加你想要执行的代码
                }
            }
    ...
    <>
     { initDone &&
        <main className="bg-block h-fit w-full flex-1 absolute top-0 box-border bg-[#100F22] relative selector">
            <div id="bannerWrap" className="section mx-auto w-full lg:h-screen sm:h-banner bg-cover relative z-1">
                <Suspense>
