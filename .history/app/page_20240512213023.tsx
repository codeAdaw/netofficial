                ...
                <ReactFullpage
                    ...
                    render={({ state, fullpageApi }) => {
                        return (
                            ...
                            {/* part 1 */}
                                <div className="section bg-[#100F22] mx-auto w-full lg:h-screen sm:h-auto bg-cover lg:px-28  sm:px-mspace">
                            ...
                            {/* part 2 */}
                                ...
                                <div className="section bg-[#100F22] mx-auto w-full lg:h-screen sm:h-hpart4 relative">
                                    ...
                                    <div className='absolute top-0 bottom-0 m-auto w-auto  lg:px-28 sm:px-mspace 3xl:w-3/4 3xl:relative' >
                                        <img className="mx-auto mb-10 lg:mt-24 lg:w-60 animate__animated animate__fadeIn"  src='/images/part5img.png' alt=""/>
                                ...
                                <div className="section bg-[#100F22]  sm:mb-4 text-center lg:text-3xl sm:text-2xl mx-auto font-blod leading-10 lg:px-28 3xl:w-3/4 3xl:mx-auto left-0 right-0 sm:px-mspace'">
