     ...
     { initDone &&
        <main className="bg-block h-fit w-full flex-1 absolute top-0 box-border bg-[#100F22] relative selector">
            ...
            {/* part 2 */}
                ...
                <div className="mx-auto w-full lg:h-screen sm:h-hpart4 relative">
                    ...
                    <div className='absolute top-0 bottom-0 m-auto w-auto  lg:px-28 sm:px-mspace'>
                        ...
                        <h2 className='lg:text-4xl font-medium mb-10 text-center border-solid border-b-1 border-white leading-10'>{intl.get('PART4H1')}</h2>
