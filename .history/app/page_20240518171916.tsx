                        ...
                        return (
                            <ReactFullpage.Wrapper>
                                  <div id="bannerWrap" className="bg-[#09082a] section mx-auto w-full lg:h-screen bg-cover relative">
                                        ...
                                        {
                                           !isM && 
                                           <video id="bvideo" ref={bvideo} style={{opacity: typef ? '1' : '0'}} className="lg:w-full lg:h-full sm:w-full sm:h-banner absolute top-0 z-0" controls={false} playsInline  autoPlay muted loop preload="auto" >
                                                <source src="/bannervs.mp4" type="video/mp4"/>
                                            </video>
                                        }
                                        {
                                           isM && <video style={{opacity: typef ? '1' : '0'}} className="lg:w-full lg:h-full sm:w-full sm:h-banner absolute top-24 z-0" controls={false} playsInline autoPlay muted loop preload="auto">
                            ...
                            {/* part 1 */}
                                <div className="section bg-[#100F22] mx-auto w-full lg:h-screen sm:h-screen bg-cover lg:px-28  sm:px-mspace sm:pt-20">
                                    <div className="flex lg:flex-row sm:flex-col-reverse sm:text-center items-center lg:gap-x-14 3xl:w-3/4 mx-auto">
                                        ...
                                        <div className="lg:w-120 lg:h-120 sm:w-64 sm:h-64 sm:mb-4 bg-100% z-1">
                                            {
                                                isM && 
                                                 <Suspense>
                                                   <video style={{height: '100%'}} className="full full" data-wf-ignore="true" data-object-fit="cover" playsInline autoPlay muted loop>
                            ...
                            {/* part 2 */}
                                        ...
                                        }
                                        {
                                            ...
                                            <div className="flex lg:flex-row  sm:flex-col gap-8 z-9">
                                                ...
                                                <div className="lg:w-1/2 sm:w-auto">
                                                    ...
                                                    <Suspense>
                                                        <ul className='flex justify-around lg:mt-12 sm:mt-4 z-10 lg:mb-5 sm:mb-4'>
                                                            <li className='lg:w-12 lg:h-12 sm:w-6 sm:h-6 relative'>
                                ...
                                <div className="section bg-[#100F22] mx-auto w-full lg:h-screen sm:h-screen bg-cover relative z-9">
                                    <div className='lg:h-auto lg:relative sm:relative mx-auto w-auto lg:px-28 sm:px-mspaces 3xl:w-3/4'>
                                        <h2 className='lg:text-4xl lg:mb-8 sm:text-2xl sm:mb-10 text-center font-medium sm:px-mspace'>{intl.get('PART3H1')}</h2>
                                        <img className='mx-auto lg:h-80 realtive lg:mb-8 sm:mb-10'  src='/type3 3.png' alt=""/>
                                ...
                                <div className="section bg-[#100F22] mx-auto w-full lg:h-screen sm:h-hpart4 relative sm:pt-20">
                                    ...
                                    <div className='lg:px-28 sm:px-mspace 3xl:relative' >
                                        <img className="mx-auto mb-10 lg:mt-24 sm:h-32 sm:h-auto animate__animated animate__fadeIn"  src='/images/part5img.png' alt=""/>
                                        <h2 className='lg:text-4xl sm:text-2xl font-medium mb-10 text-center border-solid border-b border-white lg:leading-maxx sm:py-5'>{intl.get('PART4H1')}</h2>
                                        <p className="lg:text-justify sm:text-left">{intl.get('PART4TEXT')}</p>
                                    </div>
                                </div>
                                <div className="section bg-[#100F22] mx-auto w-full lg:h-screen sm:h-full bg-cover relative sm:pt-20">
                                    <div className='flex lg:flex-row sm:flex-col items-center justify-around lg:px-28 sm:px-mspace 3xl:w-3/4 mx-auto'>
                                        ...
                                        <div className='lg:w-120'>
                                            ...
                                            <p className="text-base text-left lg:mb-8 sm:mb-4">{intl.get('PART5TEXT1')}</p>
